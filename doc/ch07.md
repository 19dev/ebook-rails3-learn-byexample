...
Deploy kısmında SSL aktive edelim,
...
~$ heroku create rails3ch07 --stack cedar --remote heroku07
~$ git push heroku07 ch07:master
~$ heroku run rake db:migrate --app rails3ch07
veya
~$ heroku run:detached rake db:migrate --app rails3ch07

Ok. url'de deneme zamanıdır: https://rails3ch07.herokuapp.com/ Ok
